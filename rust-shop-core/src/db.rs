...
impl<'db,'a> SqlCommandExecutor<'db,'a> {
    ...
    pub async fn find_one<T>(&mut self, query: &str) -> anyhow::Result<T> where  T:  for<'r> sqlx::FromRow<'r, MySqlRow> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
    ...
    pub async fn find_one_with<T>(&mut self, query: &str,args:MySqlArguments) -> anyhow::Result<T> where  T:  for<'r> sqlx::FromRow<'r, MySqlRow> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
    ...
    pub async fn find_option<T>(&mut self, query: &str) -> anyhow::Result<Option<T>> where  T:  for<'r> sqlx::FromRow<'r, MySqlRow> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
    ...
    pub async fn find_option_with<T>(&mut self, query: &str,args:MySqlArguments) -> anyhow::Result<Option<T>> where  T:  for<'r> sqlx::FromRow<'r, MySqlRow> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
    ...
    pub async fn find_all<T>(&mut self, query: &str) -> anyhow::Result<Vec<T>> where  T:  for<'r> sqlx::FromRow<'r, MySqlRow> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
    ...
    pub async fn find_all_with<T>(&mut self, query: &str,args:MySqlArguments) -> anyhow::Result<Vec<T>> where  T:  for<'r> sqlx::FromRow<'r, MySqlRow> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
    ...
    pub async fn scalar_one<T>(&mut self, query: &str) -> anyhow::Result<T> where  T:  sqlx::Type<sqlx::MySql> +  for<'r> sqlx::Decode<'r, sqlx::MySql> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
    ...
    pub async fn scalar_one_with<T>(&mut self, query: &str,args:MySqlArguments) -> anyhow::Result<T> where  T:  sqlx::Type<sqlx::MySql> +  for<'r> sqlx::Decode<'r, sqlx::MySql> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
    ...
    pub async fn scalar_option<T>(&mut self, query: &str) -> anyhow::Result<Option<T>> where  T: sqlx::Type<sqlx::MySql> +  for<'r> sqlx::Decode<'r, sqlx::MySql> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
    ...
    pub async fn scalar_option_with<T>(&mut self, query: &str,args:MySqlArguments) -> anyhow::Result<Option<T>> where  T:  sqlx::Type<sqlx::MySql> +  for<'r> sqlx::Decode<'r, sqlx::MySql> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
    ...
    pub async fn scalar_all<T>(&mut self, query: &str) -> anyhow::Result<Vec<T>> where  T: sqlx::Type<sqlx::MySql> +  for<'r> sqlx::Decode<'r, sqlx::MySql> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
    ...
    pub async fn scalar_all_with<T>(&mut self, query: &str,args:MySqlArguments) -> anyhow::Result<Vec<T>> where  T: sqlx::Type<sqlx::MySql> +  for<'r> sqlx::Decode<'r, sqlx::MySql> ,T:Send,T:Unpin{
        return match self {
            Self::UseTransaction(ref mut tran_manager) =>{
